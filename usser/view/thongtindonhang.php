            ...
            <div class="item-thongtin">
               ...
               <div class="Tong-nd">
                    <?php
                        foreach ($kqq as $dh ){
                            echo '
                                <a href="index.php?act=thongtinchitietdonhang&iddh='.$dh['id'].'">
                                    <div class="don-hang">
                                        <p class="thep-db">Đơn hàng :000'.$dh['id'].'</p>
                                        <div class="thongtin-donhang">
                                            <div class="item-donhang">
                                                <p >Thông tin</p>
                                                <div class="thongtin-user">
                                                    <p>Tên người mua: <strong>'.$dh['name'].'</strong></p>
                                                    <p>Số điện thoại : '.$dh['sdt'].'</p>
                                                    <p>Email : '.$dh['gmail'].'</p>
                                                    <p>Địa chỉ : '.$dh['diachi'].'</p>
                                                    <p>Ngày: '.$dh['ngay'].'/'.$dh['thang'].'/'.$dh['nam'].'</p>
                                                </div>
                                            </div>
                                            <div class="item-donhanghai">
                                                <p>Tổng số tiền:'.$dh['tongtien'].'</p>
                                                <p>Trang thái:';
                                                if($dh['trangthai']==1){
                                                    echo 'Đang xử lý';
                                                }
