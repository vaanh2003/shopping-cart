            ...
            <div class="tongHop">
                <div class="SP">
                    ...
                    <?php
                                    ...
                                    <div class="item-SP mot">
                                        ...
                                        <div class="item-buttom">
                                            <form action="index.php?act=addcart" method="post">
                                                ...
                                                <input type="hidden" name="size" value="'.$sp[5].'">
                                                <input class="nutcongchu" type="submit" name="chu1" value="-">
                                                <div class="number">'.$sp[4].'</div>
                                        ...
                                        <div class="thanhTien">
                                            ...
                                            <p class="do">'.$sp[3]*$sp[4].'</p>
                                            <form action="index.php?act=addcart" method="post">
                                                <input type="hidden" name="id" value="'.$sp[0].'">
                                                <input type="hidden" name="size" value="'.$sp[5].'">
                                                <input class="nutcongchu" type="submit" name="xoa" value="xóa">
                                            </form>
                                        </div>
                                    </div>
                                ';
                        ...
                        ?>
                    <!-- Sảng phẩm thứ hai -->
                    <!-- <div class="item-SP hai">
                        <img src="../img1/3.png" alt="" srcset="">
                        <div class="thongTin-SP">
                            <h3> HELL ON WHEELS TEE</h3>
                            <span>Đen/L</span>
                        </div>
                        <div class="item-buttom">
                        ...
                        <div class="thanhTien">
                            <p class="xam">Thành tiền:</p>
                            <p class="do">900,000₫</p>
                            <a href=""><img src="../img1/trash_icon.png" alt="" srcset=""></a>
                        </div>
                    </div>
                    <-- Sảng phẩm thứ 3 -->
                    <!-- <div class="item-SP ba">
                        <img src="../img1/7.png" alt="" srcset="">
                        <div class="thongTin-SP">
                            <h3>GAMBLING SHIRT</h3>
                            <span>Đen/L</span>
                        </div>
                        <div class="item-buttom">
                            <button type="button">+</button>
