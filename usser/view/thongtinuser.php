            ...
            <div class="item-thongtin">
               ...
               <div class="Tong-nd">
                    <div class="thongtin-user">
                        <div class="item-thongtin-user">
                            <p>Tên đăng nhập</p>
                            <input type="text" value="<?php echo''.$kq['user'].'';?>" >
                        </div>
                        <div class="item-thongtin-user" >
                            <p>Tên</p>
                            <input type="text" value="<?php echo''.$kq['name'].'';?>">
                        </div>
                        <div class="item-thongtin-user" >
                            <p>Số điện thoại</p>
                            <input type="text" value="<?php echo''.$kq['sdt'].'';?>">
                        </div>
                        <div class="item-thongtin-user" >
                            <p>Email</p>
                            <input type="text" value="<?php echo''.$kq['gmaildh'].'';?>">
                        </div>
                        <div class="item-thongtin-luu">
                            <p></p>
                            <input class="nut-luu" type="submit" value="Lưu">
                        </div>
