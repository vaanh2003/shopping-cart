                ...
                <div class="item-thong-tin">
                        ...
                        <div class="nhap-thong-tin">
                                ...
                                <div class="item-ten">
                                    ...
                                    <input class="'.$nutname.'" type="text" placeholder="Họ và tên" name="name" value="'.$hoten.'">';
                                    ?>
                                ...
                                <div class="item-lien-he">
                                        ...
                                        echo '
                                            ...
                                            <input class="'.$nutemail.'" type="text" placeholder="Email" name="gmail" value="'.$gmail.'">
                                            </div>
                                            <div class="sdt">
                                            <p class="loi-thongtin">'.$loilienhe.'</p>
                                            <input class="'.$nutlienhe.'" type="text" placeholder="Số điệt thoại" name="sdt" value="'.$sodienthoai.'"> 
                                            </div>
                                        ';
                                ...
                                <div class="item-dia-chi">
                                    ...
                                    echo '
                                        ...
                                        <input  class="'.$nutdiachi.'" type="text" placeholder="Địa chỉ" name="diachi" value="'.$diachi.'">
                                    ';
                                    ?>
                                ...
                                $tongtien=0;
                                        ...
                                        foreach ($kq as $sp ) {
                                                ...
                                                <div class="item-mac-hang-sp">
                                                        <img class="item-anh" src="'.$img.'" alt="">
